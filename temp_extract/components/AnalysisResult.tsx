              ...
              <div className="space-y-8 animate-in fade-in">
                {result.factChecks && result.factChecks.length > 0 ? (
                  result.factChecks.map((c, i) => (
                    <div key={i} className="p-8 border-2 border-servimedia-border rounded-3xl hover:border-servimedia-pink/20 transition-all space-y-4">
                  ...
                  <p className="text-center py-20 text-servimedia-gray/20">Sin verificaciones disponibles.</p>
                )}
              </div>
            )}
