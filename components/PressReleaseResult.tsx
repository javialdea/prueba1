    ...
    <div className="w-full">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:h-[80vh]">
        ...
        <div className="lg:col-span-5 flex flex-col gap-6 overflow-hidden">
          ...
          <div className="flex-grow flex flex-col bg-white rounded-3xl border border-servimedia-border shadow-sm overflow-hidden max-h-64 md:max-h-none">
            ...
            <div className="flex-grow overflow-y-auto p-6 md:p-10 font-serif text-base md:text-lg text-servimedia-gray leading-relaxed custom-scrollbar">
          ...
          <div className="flex-grow overflow-y-auto p-12 bg-white custom-scrollbar">
            <div className="max-w-3xl mx-auto space-y-12">
              ...
              <textarea
                ...
                className="w-full min-h-[300px] md:min-h-[600px] text-xl font-serif text-servimedia-gray/90 bg-white border-none focus:ring-0 p-0 resize-none leading-relaxed"
